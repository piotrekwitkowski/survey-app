...
contract Survey {
    ...
    */
        ...
        returns (string[] memory)
    {
        ...
        // transferd survey questions into local var
    ...
    */
    ...
    // todo: extend with participation contract

    /*
    Adds a participant to the current participants if the survey hasend ended yet
    param answers: array of answers to the survey
    */
    ...
    /*
    Returns results if survey has ended
    */
